...
class CorrectionRoutageModal extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      modal: false,
      ...
      const response = await fetch('/correctionRoutage/fnc',
        {
          ...
          body: JSON.stringify({
            ...
            {	        
                ...
                "descriptionFNC":this.props.idDescription
            }
            }),
        });
  ...
  render() {
    return (
      <div>
        ...
        >
          <ModalHeader toggle={this.toggle}>Correction de la fiche </ModalHeader>
          <ModalBody>
...
export default CorrectionRoutageModal;